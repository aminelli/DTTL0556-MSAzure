...
def sample_people_image_file():
    ...
    try:
        endpoint = "https://visionaidttl0556-prediction.cognitiveservices.azure.com/" # "https://visionaidttl0556.cognitiveservices.azure.com" # os.environ["VISION_ENDPOINT"]
        key = "4J7QYYuPppoanfd2LM7ZzgqSr5Cw5BQDHPGS6c4o3TOhPhuRbVsbJQQJ99BCACi5YpzXJ3w3AAAIACOGYKFK" # "AvqiNZHEKf6XoDsBhje3BU3W8ZYodiOni7xHPliwPWIYaas5jE3jJQQJ99BCACi5YpzXJ3w3AAAJACOG6hin" # os.environ["VISION_KEY"]
    except KeyError:
